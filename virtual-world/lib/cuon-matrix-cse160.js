...
class Matrix4 {
    ...
    translate(x, y, z) {
        let e = this.elements;
        e[12] = e[12] + (e[0] * x) + (e[4] * y) + (e[8] * z);
        e[13] = e[13] + (e[1] * x) + (e[5] * y) + (e[9] * z);
        e[14] = e[14] + (e[2] * x) + (e[6] * y) + (e[10] * z);
        e[15] = e[15] + (e[3] * x) + (e[7] * y) + (e[11] * z);
        return this;
    }
    ...
    dropShadowDirectionally = function(normX, normY, normZ, planeX, planeY, planeZ, lightX, lightY, lightZ) {
        let a;
        a = (planeX * normX) + (planeY * normY) + (planeZ * normZ);
